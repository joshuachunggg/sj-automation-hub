...
def command(action, data):
    ...
    if action == "publish":
        args = [python, str(ROOT / "main.py"), "--workbook", data["workbook"], "--workers", str(data.get("workers") or 1)]
